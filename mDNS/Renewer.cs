...
namespace mDNS
{
	/// <summary> The Renewer is there to send renewal announcment when the record expire for ours infos.</summary>
	// TODO: check this
	internal class Renewer /*: IThreadRunnable /*:TimerTask*/
	{
		private ILog logger = LogManager.GetLogger("Renewer");
		...
		{
			// TODO: check this
			//Enclosing_Instance.timer.schedule(this, DNSConstants.ANNOUNCED_RENEWAL_TTL_INTERVAL, DNSConstants.ANNOUNCED_RENEWAL_TTL_INTERVAL);
			Enclosing_Instance.Timer = new Timer(new TimerCallback(this.Run), null, DNSConstants.ANNOUNCED_RENEWAL_TTL_INTERVAL, DNSConstants.ANNOUNCED_RENEWAL_TTL_INTERVAL);
		}
